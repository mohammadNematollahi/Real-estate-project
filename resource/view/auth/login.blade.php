                                                ...
                                                <form action="{{ route('login.store') }}" method="post">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-right"><a href="{{ route('forgot.password') }}"
                                                                class="card-link">رمز خود
                                                                را فراموش کرده ام؟</a></div>
                                                    </div>
                                                    <a href="{{ route('register.index') }}"
                                                        class="btn btn-outline-primary float-left btn-inline">ثبت نام</a>
                                                    <button type="submit"
                                                        class="btn btn-primary float-right btn-inline">ورود</button>
                                                </form>
                                            </div>
                                        </div>
