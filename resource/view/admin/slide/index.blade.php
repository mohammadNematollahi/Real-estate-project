...
@section('head-tag')
    <title>admin setting slide</title>
@endsection
                                        ...
                                        <table class="table zero-configuration">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><?= $slide->address ?></td>
                                                    <td><?= $slide->amount ?></td>
                                                    <td><img style="width: 90px;" src="<?= asset($slide->image) ?>"
                                                            alt=""></td>
                                                    <td style="min-width: 16rem; text-align: left;">
                                                        ...
                                                        <form class="d-inline"
                                                            action="<?= route('admin.slide.destroy', [$slide->id]) ?>"
                                                            method="post">
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit"
                                                                class="btn btn-danger waves-effect waves-light"
                                                                onclick="return confirm('do you want delete the field  <?= $slide->id ?>')">حذف</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <?}?>
